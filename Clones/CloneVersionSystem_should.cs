...
public class CloneVersionSystem_should
{
	...
	{
		var clone1 = Execute("learn 1 45","learn 55", "rollback 1", "rollback 1", "check 1").Single();
	...
	{
		var clone1 = Execute("learn 1 45", "learn 1 10500", "learn 1 200500", "rollback 1", "rollback 1", "rollback 1", "relearn 1", "relearn 1", "relearn 1", "check 1").Single();
		Assert.AreEqual("200500", clone1);
	}
	...
	{
		var clone2 = Execute("learn 1 42", "clone 1", "learn 1 10500", "check 2").Single();
