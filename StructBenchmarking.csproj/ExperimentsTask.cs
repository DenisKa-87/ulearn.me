...
namespace StructBenchmarking
{
...

    {
            ...
            IBenchmark benchmark, int repetitionsCount)
        {
            ...
            {
                classesTimes.Add(new ExperimentResult(i, benchmark.
                    MeasureDurationInMs(new ClassArrayCreationTask(i), repetitionsCount)));
                structuresTimes.Add(new ExperimentResult(i, benchmark.
                    MeasureDurationInMs(new StructArrayCreationTask(i), repetitionsCount)));
            }
